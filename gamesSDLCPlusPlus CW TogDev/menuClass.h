...
private:
	...
	std::vector< btnsStruct>btnsV = {
		{"ÏÐÎÄÎËÆÈÒÜ", {positionStartX, positionStartY, gameSettings::menuSetting.btnW, gameSettings::menuSetting.btnH}},
		{"ÍÀÑÒÐÎÉÊÈ", {positionStartX, positionStartY * 2, gameSettings::menuSetting.btnW, gameSettings::menuSetting.btnH}},
		{"Î ÏÐÈËÎÆÅÍÈÈ", {positionStartX, positionStartY * 3, gameSettings::menuSetting.btnW, gameSettings::menuSetting.btnH}},
		{"ÂÛÕÎÄ", {positionStartX,positionStartY * 4, gameSettings::menuSetting.btnW, gameSettings::menuSetting.btnH}},
	};
